...
from .views import notary_users_list, notary_detail, notary_verify, appointments, appointment_detail

urlpatterns = [
    path("notaries/", notary_users_list, name="notary_users_list"),
    path("notaries/<int:pk>/", notary_detail, name="notary_user_detail"),
    path("notaries/<int:notary_id>/appointments/<int:appointment_id>/", appointment_detail, name="notary_appointment_detail"),
