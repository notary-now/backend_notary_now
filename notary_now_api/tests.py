...
class AllNotaryTest(TestCase):
    ...
    def test_notaries_endpoint(self):
        ...
        self.assertEqual(json_response[0]['notary_values']['state_notary_number'], self.notary.state_notary_number)
...
class OneNotaryTest(TestCase):
    ...
    def test_notaries_endpoint(self):
        ...
        self.assertEqual(json_response['notary_values']['state_notary_number'], self.notary.state_notary_number)
